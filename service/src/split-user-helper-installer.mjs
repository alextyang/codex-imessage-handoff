...
export function renderHelperLaunchAgent({
  ...
  return [
    ...
    "<key>SoftResourceLimits</key><dict><key>NumberOfFiles</key><integer>128</integer><key>NumberOfProcesses</key><integer>32</integer></dict>",
    "<key>HardResourceLimits</key><dict><key>NumberOfFiles</key><integer>256</integer><key>NumberOfProcesses</key><integer>64</integer></dict>",
